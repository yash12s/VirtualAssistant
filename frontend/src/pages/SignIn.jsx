...
function SignIn() {
  ...
  return (
    ...
    <form className='w-[90%] h-[500px] max-w-[500px] bg-[#0000004e] backdrop-blur shadow-lg shadow-black-950 flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignIn}>

    <h1 className='text-[30px] font-semibold mb-[30px]'>
    <span style={{ color: '#00FFF7' }}>Sign In to</span>{' '}
...
<button
  className="min-w-[150px] h-[60px] mt-[10px] rounded-full text-black font-semibold 
             ...
             transition duration-300 shadow-md shadow-black/30" disabled={loading}>{loading? "Loading...":"Sign In"}
...
>
  Want to create a new account ?  <span className="text-blue-400 hover:text-blue-500">Sign Up</span>
</p>
